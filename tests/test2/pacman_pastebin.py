...
class Pacman(Problem):
    ...
    def successor(self, state):
        ...
        if direkcija == "istok":
            x_new = x + 1
            y_new = y
        elif direkcija == "zapad":
            x_new = x - 1
            y_new = y
        elif direkcija == "sever":
            x_new = x
            y_new = y + 1
        else:
            x_new = x
            y_new = y - 1
        if 0 < x_new < 9 and 0 < y_new < 9 and [x_new, y_new] not in self.obstacles:
            tocki_new = jadi_Tocki(x_new, y_new, tocki)
            successors["ProdolzhiPravo"] = (x_new, y_new, direkcija, tocki_new)
        ...
        if 0 < x_new < 9 and 0 < y_new < 9 and [x_new, y_new] not in self.obstacles:
            tocki_new = jadi_Tocki(x_new, y_new, tocki)
            successors["ProdolzhiNazad"] = (x_new, y_new, direkcija_new, tocki_new)
        ...
        if 0 < x_new < 9 and 0 < y_new < 9 and [x_new, y_new] not in self.obstacles:
            tocki_new = jadi_Tocki(x_new, y_new, tocki)
            successors["SvrtiLevo"] = (x_new, y_new, direkcija_new, tocki_new)
        ...
        if 0 < x_new < 9 and 0 < y_new < 9 and [x_new, y_new] not in self.obstacles:
            tocki_new = jadi_Tocki(x_new, y_new, tocki)
            successors["SvrtiDesno"] = (x_new, y_new, direkcija_new, tocki_new)
...
if __name__ == '__main__':
    ...
    brTocki = int(input())
    tocki = []
    for i in range(0, brTocki):
        tocki.append(tuple(map(int, input().split(","))))
    tockite = tuple(tocki)
    obstacles_list = [[0, 9], [1, 9], [2, 9], [3, 9], [6, 9],
                      ...
                      [4, 1], [5, 1], [6, 1], [8, 1],
                      [6, 0]]
    pacman = Pacman((x, y, direkcija, tockite), obstacles_list)
    #print(type(pacman))
