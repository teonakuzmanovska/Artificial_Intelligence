...
class Molecule(Problem):
    ...
    def successor(self, state):
        ...
        if x_new != h2_x:
            successors["RightH1"] = (h1_x, h1_y, o_x, o_y, x_new, h2_y)

        x_new = move_left(h2_x, h2_y, o_x, o_y, h1_x, h1_y, self.obstacles)
        if x_new != h2_x:
            successors["LeftH1"] = (h1_x, h1_y, o_x, o_y, x_new, h2_y)

        y_new = move_up(h2_x, h2_y, o_x, o_y, h1_x, h1_y, self.obstacles)
        if y_new != h2_y:
            successors["UpH1"] = (h1_x, h1_y, o_x, o_y, h2_x, y_new)

        y_new = move_down(h2_x, h2_y, o_x, o_y, h1_x, h1_y, self.obstacles)
        if y_new != h2_y:
            successors["DownH1"] = (h1_x, h1_y, o_x, o_y, h2_x, y_new)
...
if __name__ == '__main__':
    ...
    # obstacles_list = [[0, 1], [1, 1], [3, 1], [6, 1], [4, 2], [6, 2], [1, 3], [6, 3], [7, 3], [2, 5], [8, 5], [3, 6], [5, 6], [7, 6]]
    h1_pos = [2, 1]
    h2_pos = [2, 6]
    o_pos = [7, 2]
